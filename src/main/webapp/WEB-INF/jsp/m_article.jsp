...
<script>
    ...
    $(function () {
        grid = $("#adv").edatagrid({
            ...
            columns: [[
                ...
                {
                    field: 'content', title: '文章内容', width: 150, align: 'left',
                    editor: {type: "text", options: {required: true}}
                },
                {
                    field: 'img', title: '图片', width: 80, align: 'center',
                    editor: {type: "text", options: {required: true}}
                },
                {
                    field: 'title', title: '文章标题', width: 80, align: 'center',
                    editor: {type: "text", options: {required: true}}
                },
                {
               ...
               /* {
                    field: 'typeid', title: '文章类型', width: 100, align: 'center',
                    formatter: function (v, r, i) {
                        switch (v) {
                            case 1:
                                return "诗歌";
                ...
                {
                    field: 'img', title: '文章图片', width: 100, align: 'center', formatter: function (v, r, i) {
                        return "<img src=" + v + " height=20 />";
                    },
                    editor: {type: "text", options: {required: true}}
                },
                {
                    field: 'description', title: '文章描述', width: 500, align: 'left',
                    editor: {type: "text", options: {required: true}}
                }
            ]],
            idField:"id",
            ...
            updateUrl:"articleupdate",
            destroyUrl:"articledelete",
            saveUrl:"articlesave",
            title: "文章列表",
            toolbar: "#tb",
            ctrlSelect:true,
    ...
    function selectArticleByName(){
        $("#adv").edatagrid('load', {
            name: $("input:text[name='searchArticleByName']").val()
...
<div id="content" region="center" title="" style="padding:5px;">
    ...
    <div id="tb" style="background-color: lightblue;padding:10px 10px 10px 10px;">
        ...
        输入商品ID查询<input type="text" name="searchArticleByName" />
